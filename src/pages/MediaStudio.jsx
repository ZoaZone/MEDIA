          ...
          {!project ? (
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", background: "#f1f3f4", padding: "12px 20px", borderRadius: "8px", marginBottom: "24px", alignItems: "center" }}>
                ...
                <button onClick={() => alert("Successfully scheduled auto-pilot delivery to linked networks!")} style={{ background: "#00c14d", color: "white", border: "none", padding: "10px 18px", borderRadius: "6px", fontWeight: "bold", cursor: "pointer", fontSize: "13px" }}>
