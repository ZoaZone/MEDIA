      ...
      const res = await fetch(`${PAYPAL_BASE}/v2/checkout/orders`, {
        ...
        body: JSON.stringify({
          ...
          purchase_units: [{
            ...
            description: plan_name ? `media.aevoice.ai — ${plan_name} Plan` : "media.aevoice.ai Payment",
          }],
          application_context: {
            brand_name: "media.aevoice.ai",
            locale: "en-IN",
            landing_page: "BILLING",
            shipping_preference: "NO_SHIPPING",
            user_action: "PAY_NOW",
            return_url: "https://media.aevoice.ai/onboarding",
            cancel_url: "https://media.aevoice.ai/pricing",
          },
